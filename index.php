    ...
    <main class="mt-5">
        ...
        <section class="user-wrapper mb-5">
            ...
            <div class="user-card px-4 py-4 shadow mb-4 rounded-4">
                ...
                <dl>
                    <div class="mb-2">
                        <dt class="user-card_subtitle mb-2">予約日時</dt>
                    ...
                    <dt class="user-card_subtitle mb-2">形式</dt>
                    <dd class="fw-bold">対面 or Zoom</dd>
                </dl>
            </div>
            ...
            <div class="user-card px-4 py-4 shadow mb-4 rounded-4">
                ...
                <dl>
                    ...
                    <div class="mb-2">
                        ...
                        <dd class="fw-bold">承認待ち or 承認済み or 棄却</dd>
                    </div>

                    <div>
                        <dt class="user-card_subtitle mb-2">メッセージ</dt>
                        <dd class="fw-bold">棄却のため、再申請をお願いします。</dd>
                    </div>
                </dl>
            </div>
